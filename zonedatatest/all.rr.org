...
; [RFC1035]
; Not supported by OpenDNSSEC (Obsoloted)
...
; [RFC1035]
all.rr.org.		IN	WKS		128.32.0.10 UDP who route timed domain
...
; [RFC1348] 
67894444333322220000.all.rr.org.	IN	NSAP-PTR	host.school.de.
...
; 25 for security key
; [RFC4034][RFC3755][RFC2535]
all.rr.org.		IN	KEY		256 3 1 AwEAAaFGEndNwBD9P7Q9T3XQxhb7OQXQCaEz5l6fzfYpspo0b2FVoZ6e ymxEmkg1XKoPPo5R90e3knvMlvYnB9CccA8=
...
; [RFC1712]
all.rr.org.		IN	GPOS		-32.6882 116.8652 10.0
...
; [Patton]
all.rr.org.		IN	EID		813F 4B7C DAB3 4217

; NIMLOC
; 32 Nimrod Locator
; [Patton]
all.rr.org.		IN	NIMLOC		752341 59EAC4 5780 0920
...
; 40 SINK
; [Eastlake]
; Do we support this one? Could not find an example.
